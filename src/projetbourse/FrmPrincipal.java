...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        trad1.getActions().add(act1);
        trad1.getActions().add(act2);
        trad1.getActions().add(act7);
        trad2.getActions().add(act1);
        trad2.getActions().add(act3);
        trad2.getActions().add(act4);
        trad2.getActions().add(act5);
        trad3.getActions().add(act6);
        trad3.getActions().add(act7);
        trad4.getActions().add(act4);
        trad4.getActions().add(act5);
        trad4.getActions().add(act1);
        ...
        for(Trader trad : mesTraders)
        {
            if(trad.getIdTrader() == Integer.parseInt(tblTraders.getValueAt(tblTraders.getSelectedRow(),0).toString()))
            {
                ...
                valeurReel = valeurReel + act.getValeurAction();
                  ...
                  Portefeuille = (double)(Portefeuille + (act.getValeurAction()*act.getQuantiteAchatAction())-(act.getPrixAchatAction()*act.getQuantiteAchatAction()));
                }
            }
        }
